...
export function WhatsAppBubble() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 group flex items-center gap-3 rounded-full bg-ink text-ivory pl-4 pr-5 py-3 shadow-lift hover:bg-ink/90 transition-colors"
    >
