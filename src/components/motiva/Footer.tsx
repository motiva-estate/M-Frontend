        ...
        <div className="grid md:grid-cols-12 gap-10 pb-16">
          <div className="md:col-span-5">
            ...
            <p className="text-ink/65 max-w-sm text-[14px] leading-relaxed">
              Motiva Estate Company — a fully integrated real-estate practice founded in 2010, delivering development, advisory, management, project and brokerage services from Lagos and Abuja.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-4 text-[13px]">
              <a href="https://wa.me/2348153242398" className="inline-flex items-center gap-2 rounded-full bg-ink text-ivory px-4 py-2 hover:bg-ink/90 transition-colors">
                <span className="h-1.5 w-1.5 rounded-full bg-gilt" /> WhatsApp us
              </a>
              <a href="tel:+2348153242398" className="text-ink/70 hover:text-ink">+234 815 324 2398</a>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-[13px] text-ink/70">
              ...
              <li><a href="/#process" className="hover:text-ink">Method</a></li>
              <li><a href="/#journal" className="hover:text-ink">Journal</a></li>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3 text-[13px] text-ink/70">
              <li><Link to="/projects" className="hover:text-ink">Residences</Link></li>
              <li><Link to="/gallery" className="hover:text-ink">Gallery</Link></li>
              <li><Link to="/contact" className="hover:text-ink">Contact</Link></li>
              <li><Link to="/contact" search={{ intent: "inspection" }} className="hover:text-ink">Book inspection</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-[13px] text-ink/70 leading-relaxed">
              <span className="block text-[10px] tracking-[0.25em] uppercase text-gilt mb-1">Abuja</span>
              5 OP Fingesi Street, Utako<br />
              <span className="block text-[10px] tracking-[0.25em] uppercase text-gilt mt-4 mb-1">Lagos</span>
              11 Michael Adebamowo,<br />Olorunda Estate, Ketu<br />
